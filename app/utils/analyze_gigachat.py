...
def analyze_word_frequency_gigachat(word_frequencies, question):
    ...
    payload = json.dumps({
        ...
        "messages": [
            {
            "role": "system",
            "content": "Ты профессиональный аналитик. Тебе необходимо проанализировать распределение по частоте ответов на вопрос. Выдай краткую аналитику по предоставленным результатам. Не перечисляй ответы."
            },
            {
            "role": "user",
            "content": f"{prompt}"
